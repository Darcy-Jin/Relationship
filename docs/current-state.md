...
- 已补充《男性 IP 外貌与形象约束 V1》：固定真实头脸比例、发际线、眉眼、鼻嘴、皮肤和普通成年男性体型，明确禁止 AI 自动美化成“标准帅哥 / 霸总模板”；
...
锁住当前普通女性角色基线
↓
建立固定男性 IP 脸（以用户本人为原型）
↓
先做 Identity Fidelity 测试：只验证“像不像本人”
↓
建立经过人工确认的 Identity Master（正脸 / 3⁄4 / 侧脸 / 表情）
↓
再测试漫画化以后是否仍能认出本人
↓
男性 IP 保持同一张脸，但职业 / 条件 / 生活方式 / 性格表现按故事变化
↓
用同一组人物做画风对比
↓
只比较画风，不再换脸 / 换身材 / 换人物气质
↓
确定第一版画风
↓
生成《互联网大厂男友》5 页正式图
