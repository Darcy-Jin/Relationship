...
- 女性代入角色现在新增一个**并行的“老婆脸版”**：原来的普通女性角色基线继续保留，不删除、不覆盖。
- 已新增 `docs/content/ai-comic/characters/female-wife-face-v0.md`，当前先锁真实身份结构：下巴不尖；额头→太阳穴→颧骨→腮帮外轮廓相对平、相对直；保留颧骨与苹果肌；单眼皮、自然偏细长眼型。
- 老婆脸版当前仍是 **Identity Anchor Draft**，尚未升级为 Identity Master。下一轮不做复杂角色板，而是“真人原图 + 同一张脸的多画风并排对比”，先验证像不像本人。
- 2026-09-25 身份校准继续补充：眼神长期有“软、松、带一点雾感”的稳定特征，表现为眼睑放松、眼白暴露少、聚焦不锋利，而不是失焦或无神；3/4 / 侧脸必须继续保留颧骨下方软组织、轻微婴儿肥、柔和下颌转折和圆润下巴，不能一转侧面就滑成尖脸 / 美型脸。
- 2026-09-25 连续对比后，老婆脸版身份锚点升级为 v0.3：头脸整体纵向偏长，但头顶 / 额头更宽更圆、下巴圆润；五官相对集中在长头脸中部；颧骨和鼻侧苹果肌更立体；颧骨下方 / 下巴两侧保留局部轻微婴儿肥但不能把整张脸画胖；嘴不能过小；笑容必须由眼睛、颧骨、苹果肌、嘴和下半脸共同参与，并保留嘴角向下到下巴附近的自然细表情线。新增的年轻时期照片被明确作为**跨年龄身份验证证据**，不是“年轻版”的另一套脸；上述头脸特征被视为长期稳定。唯一已知需要按时期处理的是眼皮：早期单眼皮，后期因做过双眼皮可出现双眼皮，但眼型、眉眼关系和整体身份不变。本人笑容还需保留温柔可爱之外的一点灵动 / 古灵精怪和有主意的感觉。
...
并行完善“老婆脸版”女性身份锚点
↓
用真人原图 + 多画风并排测试 Identity Fidelity
↓
先校准下巴 / 脸侧轮廓 / 颧骨与苹果肌 / 单眼皮
↓
用户明确确认“这张脸就是她”后，再升级为女性 Identity Master
↓
男性继续使用已确认的固定 IP Identity Master
↓
用固定人物身份做画风对比，不再一边换画风一边换脸
↓
确定第一版画风
↓
生成《互联网大厂男友》5 页正式图
