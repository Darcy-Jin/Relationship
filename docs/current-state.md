...
- 2026-09-25 参考图使用规则进一步修正：**现在照片作为结构基线**；年轻照片不再进入主结构校准区，而用于验证跨年龄稳定特征和补充表情机制。特别记录：她某些笑容会“努嘴角”，让下半脸被轻微撑开，在侧转角度下造成下巴视觉上更尖的假象；该动态尖感不能写回静态骨相。
- 2026-09-25 对比当前第 3、4 张生活照后，老婆脸版身份锚点升级为 v0.6：眼神的“朦胧”进一步定义为眼睑放松、眼白暴露少、黑白反差与高光克制、聚焦不锋利；习惯性微笑不再强制“整张脸明显一起笑”，而区分“努嘴角 / 略僵的本人假笑感”和真正开心时的全脸笑；下巴问题被拆成“下巴本身过窄 / 过尖 + 下巴两侧软组织缺失”；3/4 / 侧脸必须保留眼下—颧骨前方的中脸体积、苹果肌、下颊软组织和圆润下巴，否则会滑成美型侧脸。
- 2026-09-25 进一步测量后，老婆脸版升级为 v0.7：当前更强的解释不是“圆脸”，而是**头脸外轮廓紧凑、偏小、偏窄长的椭圆感 + 五官相对集中 + 中脸 / 下颊保留软组织 + 圆下巴**。基于当前接近正面的照片校正倾斜后粗测，头顶到下巴 / 最大头脸宽约 1.35～1.40，眼线到嘴线的主要五官区约占整个头高 30～32%。多人合照只能弱支持“头小”直觉，因透视不可作为绝对头围证据；正式生成规则暂时锁“紧凑窄长外轮廓”，避免把“窄”画成 V 脸、把“婴儿肥”画成整脸加宽。
- 2026-09-25 老婆脸版升级为 v0.8：不再简单规定“现在照片定结构、年轻照片只补充”。正式改为 **跨年龄照片共同建立 Identity；现在照片单独决定 Current State**。用户明确认为最新校准板“整体很像”，因此该结果记为 **Positive Sample / Near Pass**：说明较早照片中确实保留了长期稳定的身份特征，但还需把历史状态与当前状态分离干净。下一轮使用“Identity 文字约束 + 少量现在照片”验证当前版本，通过后再冻结 Female Identity Master v1 + Current State v1。
