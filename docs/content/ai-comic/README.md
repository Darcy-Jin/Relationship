...
## 0. 当前战略位置：AI 漫画先负责市场入口，不代表项目只剩漫画

当前选择 AI 漫画，不是因为 Relationship 的核心是 AI，也不是因为漫画天然优于所有媒介。

当前原因更实际：

- 创作者能判断图片和漫画的好坏，愿意长期做；
- 现有 AI 流程已经把内容和视觉生产成本显著压低；
- 内容矩阵、Series Entry、Topic Pool 和 Validation Script 已经形成批量生产基础；
- 漫画可以先低成本验证哪些关系问题真的有人愿意看、讨论和继续关注。
...
真正决定“讲什么、为什么值得讲、人物逻辑是否成立”的责任仍然在人。

### 0.2 当前哪些相对稳定，哪些允许替换

当前相对稳定：

- 用“选择 / 取舍 / 共同生活”作为内容深层逻辑；
- 先用视觉漫画作为主要内容形式；
- 通过真实发布而不是内部想象判断市场。
...
- 单篇选题 / 标题；
- 男 / 女 Actor 与头像策略；
- Character Style 与视觉呈现；
- 恋爱决策内部的细分切口；
- 后续商业化方式。

默认不把一次失败解释成“整个项目不行”。先找失败发生在哪一层，再只改那一层。
